...
```{=html}
<iframe width="910" height="1000" src="https://radiantearth.github.io/stac-browser/#/external/raw.githubusercontent.com/LTREB-reservoirs/vera4cast-catalog/refs/heads/main/catalog.json" title="Webpage example"></iframe>
```
